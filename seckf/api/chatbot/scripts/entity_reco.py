def entity_data():
    vuln_dict = {'xss': 'xss injection', 'cross site scripting': 'xss injection',
                 'malicious script is injected directly': 'xss injection',
                 'Sessions pattern': 'Sessions pattern',
                 'unauthenticated access security logs': 'Unauthorized and unauthenticated access security logs',
                 ...
                 'Disallow the use of old passwords': 'Disallow the use of old passwords',
                 'Absolute time out': 'Absolute session time out',
                 'Identify external dependencies': 'Identify external dependencies',
                 'session time out': 'Absolute session time out',
                 'Absolute session time out': 'Absolute session time out',
                 'Incorrect or missing charset': 'Incorrect or missing charset',
                 'Incorrect or missing charset': 'Incorrect charset', 'missing charset': 'Incorrect or missing charset',
                 'Protecting device memory': 'Protecting device memory',
                 'Protect device memory': 'Protecting device memory',
                 'HTTP strict transport security': 'HTTP strict transport security',
                 'HTTP transport security': 'HTTP strict transport security',
                 'HTTP security': 'HTTP strict transport security',
                 'Val,idated cryptographic': 'Validated cryptographic modules',
                 'Validated cryptographic modules': 'Validated cryptographic modules',
                 'Block weak passphrases': 'Block common password and weak passphrases',
                 ...
                 'Build proccess security hardening': 'Build proccess security hardening',
                 'administrative interfaces': 'administrative interfaces must not be accessible to untrusted parties',
                 ...
                 'File inclusion attack': 'File inclusion attack',
                 'deploy in a secure fashion': 'Build and deploy in a secure fashion',
                 ...
                 'Domain cookies': 'Session Domain cookies',
                 'Enforce sensitive information': 'Enforce sensitive information to be stored encrypted on device',
                 ...
                 'Limiting user input size': 'Limiting user input size',
                 'Limiting input size': 'Limiting user input size',
                 'Canonicalized input': 'Canonicalized user input',
                 'Canonicalized user input': 'Canonicalized user input',
                 'step up authentication': 'step up or adaptive authentication',
                 ...
                 'IP adresses in internal HTTP headers': 'IP adresses in internal HTTP headers',
                 'LDAP': 'LDAP injection',
                 ...
                 'TLS implementation': 'TLS implementation must operate in an approved mode of operation',
                 ...
                 'File upload outside document root': 'File upload outside document root',
                 ...
                 'Enforce policys for sensitive data processing': 'Enforce policys for sensitive data processing',
                 ...
                 'XML injection': 'XML injection', 'TLS implementation': 'TLS implementation',
                 ...
                 'Forget password functions': 'Forget password functions', 'File': 'File',
                 ...
                 'Log TLS connection failures': 'Log TLS connection failures',
                 'Sandboxing malicious code': 'Sandboxing malicious code',
                 ...
                 'Intrusion detecting and reporting': 'Intrusion detecting and reporting',
                 'XSLT injections': 'XSLT injections',
                 ...
                 'Approved random number generator': 'Approved random number generator',
                 ...
                 'File upload injections': 'File upload injections',
                 'Client side constraints': 'Client side constraints',
                 'Application assets hosted on secure location': 'Application assets hosted on secure location',
                 'Context sensitive authorization': 'Context sensitive authorization',
                 ...
                 'Identifier based authorization': 'Identifier based authorization', 'CSRF on REST': 'CSRF on REST',
                 'User credentials in audit logs': 'User credentials in audit logs',
                 ...
                 'STRIDE': 'STRIDE', 'Identify all components': 'Identify all components',
                 'Aggregate access control protection': 'Aggregate access control protection',
                 'Re authentication': 'Re authentication',
                 'Does The application enforce the use of secure passwords': 'Does The application enforce the use of secure passwords',
                 'Command injection': 'Command injection',
                 'Sensitive information stored alongside the source code': 'Sensitive information stored alongside the source code',
                 'Client side storage': 'Client side storage',
                 'Open forward and Open redirects': 'Open forward and Open redirects',
                 'Are all passwords hashed, salted and stretched': 'Are all passwords hashed, salted and stretched',
                 'Forward secrecy ciphers': 'Forward secrecy ciphers',
                 'Aggregate user requests': 'Aggregate user requests',
                 'Do not support untrusted client side technologies': 'Do not support untrusted client side technologies',
                 'Hardware key vault': 'Hardware key vault',
                 'All authentication controls must fail securely': 'All authentication controls must fail securely',
                 'Client side state management': 'Client side state management',
                 'X Path': 'X Path injections', 'X Path injections': 'X Path injections',
                 'HSTS preload': 'HSTS preload', 'cross subdomain cookie attack': 'cross subdomain cookie attack',
                 'Signed message payloads': 'Signed message payloads',
                 'Sanitize unstructured data': 'Sanitize unstructured data',
                 'Denial of service by locking out accounts': 'Denial of service by locking out accounts',
                 'Zero keys and secrets before destroying them': 'Zero keys and secrets before destroying them',
                 'Unnecessary features enabled or installed': 'Unnecessary features enabled or installed',
                 'XML attacks': 'XML attacks',
                 'The logout functionality should revoke the complete session': 'The logout functionality should revoke the complete session',
                 'Content security policy headers': 'Content security policy headers',
                 'Double decoding of headers parameters': 'Double decoding of headers parameters',
                 'Automatic parameter binding': 'Automatic parameter binding',
                 'Logging implemented on the serverside': 'Logging implemented on the serverside',
                 'Sending data parameters to untrusted devices': 'Sending data parameters to untrusted devices',
                 'Submit forms pattern': 'Submit forms pattern', 'Username enumeration': 'Username enumeration',
                 'proven authentication mechanisms': 'proven authentication mechanisms',
                 'Enforce random numbers are created with proper entropy at runtime': 'Enforce random numbers are created with proper entropy at runtime',
                 'Directory listing': 'Directory listing',
                 'Brute force password guessing': 'Brute force password guessing',
                 'Client side authentication': 'Client side authentication',
                 'Encrypt sensitive information different depending on context': 'Encrypt sensitive information different depending on context',
                 'Single input validation controls': 'Single input validation controls',
                 'Protection against different exfiltration techniques': 'Protection against different exfiltration techniques',
                 'Prevent password pre filling': 'Prevent password pre filling',
                 'Access control pattern': 'Access control pattern', 'Distinguish log': 'Distinguish log',
                 'not available item': 'not available item', 'Cross site request forgery': 'Cross site request forgery',
                 'cryptographic function implementation': 'cryptographic function implementation',
                 'Deny access from remote resources or systems': 'Deny access from remote resources or systems',
                 'Keys and passwords should be replaceable': 'Keys and passwords should be replaceable',
                 'Logging validation failures': 'Logging validation failures',
                 'Automated spamming via feedback scripts': 'Automated spamming via feedback scripts',
                 'cryptographic modules must fail securely': 'cryptographic modules must fail securely',
                 'Parsing data  exchange formats': 'Parsing data  exchange formats',
                 'Positive validation model': 'Positive validation model',
                 'Server side validation': 'Server side validation',
                 'Server side request forgery': 'Server side request forgery',
                 'API resonses security headers': 'API resonses security headers',
                 'Session cookies without the Secure flag': 'Session cookies without the Secure flag',
                 'Integrity check and authorised modification': 'Integrity check and authorised modification',
                 'Protect agains exported activities or content providers': 'Protect agains exported activities or content providers',
                 'Strong CRYPTO through CA hierachy': 'Strong CRYPTO through CA hierachy',
                 'Centralized the mechanisms for protecting resources and the access': 'Centralized the mechanisms for protecting resources and the access',
                 'TLS settings are in line with current leading practice': 'TLS settings are in line with current leading practice',
                 'XXE injections': 'XXE injections',
                 'Communication between components (low privileges)': 'Communication between components (low privileges)',
                 'File upload anti virus check': 'File upload anti virus check',
                 'Data retention policy': 'Data retention policy', 'PII protection': 'PII protection',
                 'High level architecture should be defined': 'High level architecture should be defined',
                 'Robots.txt': 'Robots.txt',
                 'Protect sensitive activities intents or content providers': 'Protect sensitive activities intents or content providers',
                 'Avoid the use of default and predictable acounts.': 'Avoid the use of default and predictable acounts.',
                 'Verbose version information': 'Verbose version information',
                 'Verify integrity using checksums': 'Verify integrity using checksums',
                 'Unproven cryptographic algorithms': 'Unproven cryptographic algorithms',
                 'Verify that structured data is strongly typed and validated': 'Verify that structured data is strongly typed and validated',
                 'Session IDs do not timeout (idl)': 'Session IDs do not timeout (idl)',
                 'Disable autocomplete for all the input fields in forms': 'Disable autocomplete for all the input fields in forms',
                 'authenticated data cleared from client storage': 'authenticated data cleared from client storage',
                 'Verify that the session id is never disclosed': 'Verify that the session id is never disclosed',
                 'Ensure overall security': 'Ensure overall security',
                 'Dynamic scripting injection': 'Dynamic scripting injection',
                 'Insecure datastorage': 'Insecure datastorage', 'Logout structuring': 'Logout structuring',
                 'Cryptographic modules should operate in their approved mode according to their published security policies': 'Cryptographic modules should operate in their approved mode according to their published security policies',
                 'Auto escaping technology': 'Auto escaping technology',
                 'Session management control': 'Session management control',
                 'Sensitive information in code or online repositories': 'Sensitive information inx code or online repositories',
                 'Generate strong crypto tokens with at least 120 bit of effective entropy': 'Generate strong crypto tokens with at least 120 bit of effective entropy',
