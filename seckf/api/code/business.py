from seckf.api.security import log, val_num, val_alpha_num, val_alpha_num_special
...
def get_code_items_checklist_kb(checklist_kb_id):
    log("User requested list of code items", "LOW", "PASS")
    result = ChecklistKBCodeItem.query.filter(ChecklistKBCodeItem.checklist_kb_id == checklist_kb_id).paginate(1, 2500,
                                                                                                               False)
    return result
